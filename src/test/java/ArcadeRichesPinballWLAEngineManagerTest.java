...
public class ArcadeRichesPinballWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(ArcadeRichesPinballWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/ArcadeRichesPinballWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/ArcadeRichesPinballWLAIW/InitOutcome.xml").getDocumentElement();
